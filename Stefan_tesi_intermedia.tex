		...
		\begin{columns}
			...
			\begin{itemize}
				...
				\begin{itemize}
					...
					{\footnotesize
					\item[$-$] External 12b DAC $\rightarrow$ global Vth
					\item[$-$] Internal 6b DAC $\rightarrow$ Ch uniformity
				}
				\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\frametitle{Threshold scan}
		\begin{itemize}
			...
			\item {\color{blue}Blue} curve: trimming DAC code= \textbf{0}
			\item {\color{green}Green} curve: trimming DAC code= \textbf{63}
			\item S-curve shifted as expected  
		\end{itemize}	
		\begin{center}
	...
	\begin{itemize}
		\item DC pre-amp output voltage values for selected channels
		\item {\color{blue}Blue} dots: trimming DAC code= \textbf{0}
		\item {\color{green}Green} dots: trimming DAC code= \textbf{63}
